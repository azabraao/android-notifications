package br.com.azabraao.androidnotifications;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notificationChannel =
                new NotificationChannel(CHANNEL_PROMOCOES_ID, "Promoções", NotificationManager.IMPORTANCE_DEFAULT);
    ...
    public void notificacaoPersonalizada(View view) {
        ...
        NotificationCompat.Builder notification =
                new NotificationCompat.Builder(this,CHANNEL_PROMOCOES_ID);

        notification.setContentTitle("COmpre agoraaaa");
    ...
    public void notificacaoFixa(View view) {
        String msg = String.format("O numero de notificações é: %d", ++contador);
